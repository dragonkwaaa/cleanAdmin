...
<div class="container webSort">
	...
	<div class="content">
					...
					<table class="regTable">
						...
						<tbody>
							...
							<tr>
								<th>담당업체</th>
								<td>
                                    <div class="sbox regFullSort">
				                    	<select name="">
				                    		<option value="1">에이디치히얌</option>
				                    		<option value="2">태인</option>
				                    	</select>
				                    </div>
								</td>
                            </tr>
                            <tr>
								...
								<td>
                                    <div class="sbox regFullSort">
				                    	<select name="">
				                    		<option value="1">직원휴게실</option>
				                    		<option value="2">분체도장 1 작업실</option>
				                    	</select>
				                    </div>
								</td>
							</tr>
        ...
        <div class="listSection shortVent">
