...
<div class="container webSort">
	...
	<div class="content">
		<div class="tableGroup">
			<div class="tableMenu">
				<div class="sbox">
					<select>
						...
						<option value="">광명 분체도장 공장</option>
						<option value="">오산 자동차 외장 작업장</option>
					</select>
				</div>
				<div class="sbox">
					<select>
						<option value="">- 구역 선택 -</option>
						<option value="">도장 작업장</option>
			...
			<div class="tableBox">
				<div class="tableTimeCheck">
					<span class="fs14 fw_bold">마지막 측정시간 : </span>
					<span class="fs14 fm_mon">2020-01-20 11:18:44</span>
				</div>
